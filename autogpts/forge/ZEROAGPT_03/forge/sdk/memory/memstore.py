...
class MemStore(abc.ABC):
    ...
    #     """
    #     Weaviate based method to add data objects to client per class
    #     Return uuid of added object
    #     """
    #     pass

    # @abc.abstractmethod
    # def get_data_obj(self, data_class: str, query: str) -> list:
    #     """
    #     Weaviate based method for using simularity search to find a data by query
    #     Returns a list of data objects found
    #     """
    #     pass
